 ...
 */
class SendPress_Email_Templates_Table extends WP_List_Table {
		...
		switch($column_name){
		   ...
		   */
			...
			case 'actions':
				...
				$a .= '<a class="btn btn-primary" href="?page='.$_REQUEST['page'].'&view=style&emailID='. $item->ID .'"><span class="glyphicon glyphicon-edit"></span> ' . __('Edit', 'sendpress') . '</a> ';
	...
	function column_title($item){
		...
		$actions = array(
			'edit'      => sprintf('<a href="?page=%s&view=%s&emailID=%s">%s</a>',$_REQUEST['page'],'style',$item->ID, __('Edit','sendpress') ),
			'delete'    => sprintf('<a href="?page=%s&action=%s&emailID=%s">%s</a>',$_REQUEST['page'],'delete-email',$item->ID,__('Delete','sendpress') ),
		);
