...
class SendPress_View_Reports extends SendPress_View{
	...
	function html($sp){
		...
		<div class='well'>
		<span class="label label-success"><?php _e('Unique'); ?></span> <?php _e('The total number of different recipients that have clicked on a link or opened an email.'); ?><br><br>

		<span class="label label-info"><?php _e('Total');?></span> <?php _e('The total number of clicks or opens that have happened. Regardless of who clicked or opened the email.'); ?>
		</div>
		<?php
