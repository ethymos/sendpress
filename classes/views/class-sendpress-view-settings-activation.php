...
<div class="boxer form-box">
	...
	<br><b><?php _e('Use theme styles:', 'sendpress'); ?>&nbsp;&nbsp;&nbsp;<input type="radio" value="yes" <?php if(SendPress_Option::get('try-theme')=='yes'){ echo "checked='checked'"; } ?> name="try-theme"> <?php _e('Yes', 'sendpress'); ?>&nbsp;&nbsp;&nbsp;<input type="radio" value="no" <?php if(SendPress_Option::get('try-theme')=='no'){ echo "checked='checked'"; } ?> name="try-theme"> <?php _e('No', 'sendpress'); ?></b>
	...
	<div class="sp-row">
			<div class="sp-33 sp-first"><b><?php _e('Manage Page', 'sendpress'); ?></b><br>
				<div class='well'>
					<?php _e('This is the page subscribers are directed to manage their subscriptions to your lists.', 'sendpress'); ?>
					<br><br>
...
<a class="btn btn-default" href="<?php echo site_url(); ?>?sendpress=confirm"><?php _e('View Page', 'sendpress'); ?></a>
			...
			<div class="sp-33"><b><?php _e('Post Page', 'sendpress'); ?></b><br>
				<div class='well'>
					...
					<br><br>
					<a class="btn btn-default" href="<?php echo site_url(); ?>?sendpress=post"><?php _e('View Page', 'sendpress'); ?></a>
				</div>
...
<div class="boxer form-box">
	...
	<div style="float: right; width: 45%;"><br>
		...
		<?php if(strpos($dpost->post_content,'*|SP:CONFIRMLINK|*'  )  == false){ echo "<div class='alert alert-error'>" . __('Missing', 'sendpress') . "<b>*|SP:CONFIRMLINK|*</b> " . __('in body content.') . "</div>";} ?>
