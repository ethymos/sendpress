    ...
    function column_default($item, $column_name){
        switch($column_name){
           ...
           case 'actions':
                ...
                $a .= '<a class="btn btn-primary" href="'. SendPress_Admin::link('Subscribers_Subscriber', array('subscriberID'=>$item->subscriberID )) .'"><span class="glyphicon glyphicon-pencil"></span>  ' . __('Edit') . '</a> ';
